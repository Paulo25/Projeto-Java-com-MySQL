...
public class TelaOS extends javax.swing.JInternalFrame {
    ...
    Connection conexao = null;  //conectar
    PreparedStatement pst = null; //executar
    ResultSet rs = null;  //trazer resultados do banco

    //a linha abaixo cria uma variavel para armazenar um texto de acordo com o radion button selecionado
    private String tipo;

    //linha abaixo construtor - inicializa automaticamente a conexao com o banco
    public TelaOS() {
        initComponents();
        //Inicializa a conexao com banco
        conexao = ModuloConexao.conector();
    }

    //pesquisa avanaçada usando blioteca rs2xml.jar
    ...
    private void setar_campos() {
        //atribui a variavel o conteudo da linha selecionada na tabela
        int setar = tblClientes.getSelectedRow();
        //vincula o campo txtIdCli com o nome correspondente no banco
    ...
    private void emitir_os() {
        ...
        try {
            pst = conexao.prepareStatement(sql);
            pst.setString(1, tipo);//conteudo a variavel tipo "radiobutton"
            pst.setString(2, cboOsSit.getSelectedItem().toString());//campo situação do formulario
            ...
            if ((txtCliId.getText().isEmpty()) || (txtOsEquip.getText().isEmpty()) || (txtOsDef.getText().isEmpty())) {
                JOptionPane.showMessageDialog(null, "Preenchar todos os campos obrigatórios");
            } else {
    ...
    private void pesquisar_os() {
        //a linha abaixo cria uma caixa de entrada do tipo JOption Pane e atribui a informação a essa variavel abaixo
        ...
        try {
            ...
            if (rs.next()) {
                ...
                //setabdo os radio burrons
                String rbtTipo = rs.getString(3);//Esta variavel recebe o conteudo do campo tipo do banco
    ...
    private void imprimir_os(){
        ...
        if(confirma == JOptionPane.YES_OPTION){
            ...
            filtro.put("os",Integer.parseInt(txtOs.getText()));//nome que ultilizou na ferramenta ireport
            //emitindo relatório co o framework JasperReport
            try {
                //Usando a classe JasperPrint para preparar a impressão de um relatório
                JasperPrint print = JasperFillManager.fillReport("C:/BACKUP-Vitor/Sistema de OS/reports/os.jasper",filtro,conexao);
    ...
    private void initComponents() {
        ...
        setToolTipText("");
        setPreferredSize(new java.awt.Dimension(624, 440));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/lupa5.png"))); // NOI18N
        ...
        btnOsAdicionar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/create0.png"))); // NOI18N
        ...
        btnOsPesquisar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/pesquisa0.png"))); // NOI18N
        ...
        btnOsExcluir.setIcon(new javax.swing.ImageIcon(getClass().getResource("/br/com/infox/icones/delete0.png"))); // NOI18N
                    ...
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(txtOsEquip, javax.swing.GroupLayout.PREFERRED_SIZE, 582, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtOsServ, javax.swing.GroupLayout.PREFERRED_SIZE, 582, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtOsDef, javax.swing.GroupLayout.PREFERRED_SIZE, 582, javax.swing.GroupLayout.PREFERRED_SIZE)))
                            .addGroup(layout.createSequentialGroup()
                                .addGap(36, 36, 36)
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(btnOsImprimir, javax.swing.GroupLayout.Alignment.LEADING))
    ...
    private void rbtOrcActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtOrcActionPerformed
        //atribuindo um texto a variavel tipo se for selecionado e armazenar o texto no banco
        tipo = "Orçamento";
    ...
    private void rbtOsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_rbtOsActionPerformed
        //atribuindo um texto a variavel tipo se o radio button estiver selecionado
        tipo = "OS";
